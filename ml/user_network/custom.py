...
class Model(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, hidden_size, num_class, num_fiducial, Transformation, FeatureExtraction, SequenceModeling, Prediction, imgH, imgW, batch_max_length):
